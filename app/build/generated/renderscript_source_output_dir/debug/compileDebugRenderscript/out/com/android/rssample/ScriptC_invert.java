 ...
 * The source Renderscript file: /autofs/unitytravail/travail/mduban/S6/projet-android/app/src/main/rs/invert.rs
 */
...
public class ScriptC_invert extends ScriptC {
    ...
    private final static int mExportVarIdx_test = 0;
    private int mExportVar_test;
    public synchronized void set_test(int v) {
        setVar(mExportVarIdx_test, v);
        mExportVar_test = v;
    }

    public int get_test() {
        return mExportVar_test;
    }

    public Script.FieldID getFieldID_test() {
        return createFieldID(mExportVarIdx_test, null);
    }
